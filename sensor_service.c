...
#include "sensor_service.h"
//#ifndef MOUSE2
//    #include "sensor_service_2.h"
//    #endif
//#ifndef MOUSE3
//    #include "sensor_service_3.h"
//    #endif
//#ifndef MOUSE4
//    #include "sensor_service_4.h"
//    #endif
//#ifndef MOUSE5
//    #include "sensor_service_5.h"
//#endif
...
void sensor1_characteristic_update(ble_os_t *p_sensor_service, int32_t *temp)
{
    // SENSOR_JOB: Step 3.E, Update characteristic value
		if (p_sensor_service->conn_handle != BLE_CONN_HANDLE_INVALID)
		{
				...
				hvx_params.p_data = (int32_t*)temp;  
